...
const filePath = path.join(__dirname, 'src/views/tenant-customers/Detail/BasicInfoCard.vue');
...
console.log('✅ BasicInfoCard.vue 已成功写入！');

// 验证
const written = fs.readFileSync(filePath, 'utf8');
console.log('包含"更多信息":', written.includes('更多信息'));
console.log('包含"系统密码":', written.includes('系统密码'));
console.log('行数:', written.split('\n').length);
