<template>
  <el-card shadow="never" class="info-card">
    ...
    <el-table :data="bills" stripe v-loading="loading" style="width: 100%" table-layout="fixed">
...
import { formatDateTime, getBillStatusType, getBillStatusText, getBillPayTypeText } from './helpers'
